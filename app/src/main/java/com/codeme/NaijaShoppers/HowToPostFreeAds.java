...
public class HowToPostFreeAds extends Fragment {
    public WebView webV;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View mView = inflater.inflate(R.layout.how_to_post_free_ads, container, false);
        ...
        // Create the WebView
            ...
            webV.loadUrl("https://www.naijashoppers.net/index.php/home/page/How_to_post__FREE_ads");
            webV.restoreState(savedInstanceState);
